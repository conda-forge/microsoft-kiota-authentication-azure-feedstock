About microsoft-kiota-authentication-azure-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/microsoft-kiota-authentication-azure-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/microsoft-kiota-authentication-azure-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add microsoft-kiota-authentication-azure
# for installing globally
pixi global install microsoft-kiota-authentication-azure
```
...
It is possible to list all of the versions of `microsoft-kiota-authentication-azure` available on your platform:
...
```
pixi search microsoft-kiota-authentication-azure --channel conda-forge
```
